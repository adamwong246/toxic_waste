...
data:extend{
	...
	},
	{
		type = 'item-with-tags',
		name = 'memory-element',
		icon = '__toxic_waste__/sequestor/graphics/icon/memory-element.png',
		icon_size = 64,
		icon_mipmaps = 4,
		stack_size = 1,
		flags = {'not-stackable'},
	...
	},
	{
		...
		icon = '__toxic_waste__/sequestor/graphics/icon/empty-memory-element.png',
		icon_size = 64,
		icon_mipmaps = 4,
		stack_size = 1,
		flags = {'not-stackable'},
	...
	},
	{
		...
		icon = '__toxic_waste__/sequestor/graphics/icon/memory-communicator.png',
		icon_size = 64,
		icon_mipmaps = 4,
		stack_size = 1,
		flags = {'not-stackable'},
	...
	},
	{
		type = 'technology',
		name = 'empty-memory-element',
		icon = '__toxic_waste__/sequestor/graphics/technology/empty-memory-element.png',
		icon_size = 128,
		effects = {{
	...
	},
	{
		type = 'item',
		name = 'memory-unit',
		icon = '__toxic_waste__/sequestor/graphics/icon/memory-unit.png',
		icon_size = 64,
		icon_mipmaps = 4,
		stack_size = 10,
	...
	},
	{
		...
		inventory_size = 120,
		picture = {
			filename = '__toxic_waste__/sequestor/graphics/entity/memory-unit.png',
			height = 256,
			priority = 'high',
			width = 256,
			shift = {0.59375, 0},
			hr_version = {
				filename = '__toxic_waste__/sequestor/graphics/entity/hr-memory-unit.png',
				height = 512,
				priority = 'high',
				width = 512,
				scale = 0.5,
	...
	},
	{
		type = 'technology',
		name = 'memory-unit',
		icon = '__toxic_waste__/sequestor/graphics/technology/memory-unit.png',
		icon_size = 128,
		effects = {
			{
				recipe = 'memory-unit',
	...
	},
	{
		...
		collision_mask = {},
		remove_decoratives = 'false',
		sprites = {filename = '__toxic_waste__/sequestor/graphics/nothing.png', size = 1},
		activity_led_sprites = {filename = '__toxic_waste__/sequestor/graphics/nothing.png', size = 1},
